//
//  editEducatorLessionViewController.m
//  ecaHUB
//
...
@interface editEducatorLessionViewController () {
...
@implementation editEducatorLessionViewController
...
-(void) prepareInterface {
    ...
    //[[[[[NSUserDefaults standardUserDefaults] valueForKey:@"lessonDetail"] valueForKey:@"lesson_info"]valueForKey:@"TermsRefund"] valueForKey:@"title"]]
    
    descriptionTxtView.text = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"lessonDetail"] valueForKey:@"lesson_info"] valueForKey:@"LessonListing"] valueForKey:@"description_educator"];
    ...
    educator_name.text = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"lessonDetail"] valueForKey:@"lesson_info"] valueForKey:@"LessonListing"] valueForKey:@"name_educator"];
    
    business_type.text = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"lessonDetail"] valueForKey:@"lesson_info"] valueForKey:@"BusinessType"] valueForKey:@"title"];
    
    address.text = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"lessonDetail"] valueForKey:@"lesson_info"] valueForKey:@"LessonListing"] valueForKey:@"author_venu_unit"];
    
    building_name.text = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"lessonDetail"] valueForKey:@"lesson_info"] valueForKey:@"LessonListing"] valueForKey:@"author_venu_building_name"];
    
    number_street.text = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"lessonDetail"] valueForKey:@"lesson_info"] valueForKey:@"LessonListing"] valueForKey:@"author_venu_street"];
    
    district.text = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"lessonDetail"] valueForKey:@"lesson_info"] valueForKey:@"LessonListing"] valueForKey:@"author_venu_district"];
    
    NSString *strValue;// = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"lessonDetail"] valueForKey:@"lesson_info"] valueForKey:@"author_city"] valueForKey:@"city_name"];
//    
//    strValue = [@"  " stringByAppendingString:strValue];
//    
//    [cityBtn setTitle:strValue forState:UIControlStateNormal];
//    
//    strValue = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"lessonDetail"] valueForKey:@"lesson_info"] valueForKey:@"author_state"] valueForKey:@"state_name"];
//    
//    strValue = [@"  " stringByAppendingString:strValue];
//    
//    [stateBtn setTitle:strValue forState:UIControlStateNormal];
//    
//    strValue = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"lessonDetail"] valueForKey:@"lesson_info"] valueForKey:@"author_country"] valueForKey:@"country_name"] ;
//    
//    strValue = [@"  " stringByAppendingString:strValue];
//    
//    [countryBtn setTitle:strValue forState:UIControlStateNormal];
//    
    established_year.text = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"lessonDetail"] valueForKey:@"lesson_info"] valueForKey:@"LessonListing"] valueForKey:@"year"];
    
    strValue = [[[NSUserDefaults standardUserDefaults] valueForKey:@"lessonDetail"] valueForKey:@"offer_names"];
...
-(void) setData {
    ...
    NSString *educator_nameStr = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"lessonDetail"] valueForKey:@"lesson_info"] valueForKey:@"LessonListing"] valueForKey:@"name_educator"];
    
    business_typeId = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"lessonDetail"] valueForKey:@"lesson_info"] valueForKey:@"BusinessType"] valueForKey:@"id"];
    
    NSString *addressStr = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"lessonDetail"] valueForKey:@"lesson_info"] valueForKey:@"LessonListing"] valueForKey:@"author_venu_unit"];
    
    NSString *building_nameStr = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"lessonDetail"] valueForKey:@"lesson_info"] valueForKey:@"LessonListing"] valueForKey:@"author_venu_building_name"];
    
    NSString *number_streetStr = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"lessonDetail"] valueForKey:@"lesson_info"] valueForKey:@"LessonListing"] valueForKey:@"author_venu_street"];
    
    NSString *districtStr = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"lessonDetail"] valueForKey:@"lesson_info"] valueForKey:@"LessonListing"] valueForKey:@"author_venu_district"];
    
//    country_id = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"lessonDetail"] valueForKey:@"lesson_info"] valueForKey:@"LessonListing"] valueForKey:@"author_country_id"];
//    
//    state_id = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"lessonDetail"] valueForKey:@"lesson_info"] valueForKey:@"LessonListing"] valueForKey:@"author_state_id"];
//    
//    city_id = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"lessonDetail"] valueForKey:@"lesson_info"] valueForKey:@"LessonListing"] valueForKey:@"author_city_id"];
    
    NSString *year = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"lessonDetail"] valueForKey:@"lesson_info"] valueForKey:@"LessonListing"] valueForKey:@"year"];
    
    offersId = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"lessonDetail"] valueForKey:@"lesson_info"] valueForKey:@"LessonListing"] valueForKey:@"offer"];
...
-(BOOL)textFieldShouldReturn:(UITextField *)textField {
    ...
    if (textField == established_year) {
        ...
        if ((![validationObj validateNumberDigits: established_year.text]) || ([established_year.text length] > 4)) {
