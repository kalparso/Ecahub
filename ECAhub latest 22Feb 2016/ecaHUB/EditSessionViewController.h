...
@interface EditSessionViewController : UIViewController <UITextFieldDelegate, listingDelegate, UIPickerViewDataSource, UIPickerViewDelegate>
...
@property (weak, nonatomic) IBOutlet UIView *venue_lbl_view;
@property (weak, nonatomic) IBOutlet UIView *check_view;
