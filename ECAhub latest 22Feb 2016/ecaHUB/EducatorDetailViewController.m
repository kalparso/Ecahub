//
//  EducatorDetailViewController.m
//  ecaHUB
//
...
#import "EducatorDetailViewController.h"
#import "URL.h"
...
#import "EducatorOtherListingTableViewCell.h"

@interface EducatorDetailViewController (){
    ...
    EducatorOtherListingTableViewCell *cell;
...
@implementation EducatorDetailViewController

@synthesize scrollView, educator_imgView, educator_image, educator_name, educator_description, established_year, location, offers, category, sub_cat, total_praises, total_purchased, location_lable, total_review,sub_View,awardView,listing_table,otherlisting_lbl,establisedLbl,offersLbl,achievmentLbl,picture_view,profile_view;
...
-(void) setEducatorDetails {
    ...
    NSString *img_url = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"courseDetails"] valueForKey:@"course_info"] valueForKey:@"BusinessProfile"] valueForKey:@"identity"];
    ...
    educator_name.text = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"courseDetails"] valueForKey:@"course_info"] valueForKey:@"BusinessProfile"] valueForKey:@"name_educator"];
    
    educator_description.text = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"courseDetails"] valueForKey:@"course_info"] valueForKey:@"BusinessProfile"] valueForKey:@"description_educator"];
    ...
    established_year.text = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"courseDetails"] valueForKey:@"course_info"] valueForKey:@"BusinessProfile"] valueForKey:@"year"];
    
    NSLog(@"%@",[[[[NSUserDefaults standardUserDefaults] valueForKey:@"courseDetails"] valueForKey:@"course_info"] valueForKey:@"BusinessProfile"]);
    
//    NSString *locationStr = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"courseDetails"] valueForKey:@"course_info"] valueForKey:@"BusinessProfile"] valueForKey:@"author_venu_unit"];
//    
//    locationStr = [locationStr stringByAppendingString:@", "];
//    
//    locationStr = [locationStr stringByAppendingString:[[[[[NSUserDefaults standardUserDefaults] valueForKey:@"courseDetails"] valueForKey:@"course_info"] valueForKey:@"BusinessProfile"] valueForKey:@"author_venu_building_name"]];
//    
//    locationStr = [locationStr stringByAppendingString:@", "];
//    
//    locationStr = [locationStr stringByAppendingString:[[[[[NSUserDefaults standardUserDefaults] valueForKey:@"courseDetails"] valueForKey:@"course_info"] valueForKey:@"BusinessProfile"] valueForKey:@"author_venu_street"]];
//    
//    locationStr = [locationStr stringByAppendingString:@", "];
    
    NSString *locationStr = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"courseDetails"] valueForKey:@"course_info"] valueForKey:@"BusinessProfile"] valueForKey:@"author_venu_district"];
    
    location.text = locationStr;
    
     offers.text = [[[[NSUserDefaults standardUserDefaults] valueForKey:@"courseDetails"] valueForKey:@"offer_names"]stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceCharacterSet]];
    
    otherlisting_lbl.text = [@"Other Listings by "stringByAppendingString:[[[[[NSUserDefaults standardUserDefaults] valueForKey:@"courseDetails"] valueForKey:@"course_info"] valueForKey:@"BusinessProfile"] valueForKey:@"name_educator"]];
    
    [otherlisting_lbl setTextAlignment:NSTextAlignmentCenter];
    
    CGRect frame = established_year.frame;
    
    frame.origin.y = establisedLbl.frame.origin.y;
    
    established_year.frame = frame;
    
    frame = offers.frame;
    
    frame.origin.y =established_year.frame.origin.y + established_year.frame.size.height +5;
    
    frame.size.height = [self heightCalculate:offers.text];
    ...
    frame = location_lable.frame;
    
    frame.origin.y =offers.frame.origin.y + offers.frame.size.height +5;
    
    location_lable.frame = frame;
    ...
    frame = achievmentLbl.frame;
    
    frame.origin.y =location.frame.origin.y + location.frame.size.height +10;
    
    achievmentLbl.frame = frame;
    ...
    [location_lable sizeToFit];
    
    [location sizeToFit];
    
//    locationStr = [locationStr stringByAppendingString:@", "];
//    
//    locationStr = [locationStr stringByAppendingString:[[[[[[NSUserDefaults standardUserDefaults] valueForKey:@"courseDetails"] valueForKey:@"course_info"] valueForKey:@"BusinessProfile"] valueForKey:@"author_city"] valueForKey:@"city_name"]];
//    
//    locationStr = [locationStr stringByAppendingString:@", "];
//    
//    locationStr = [locationStr stringByAppendingString:[[[[[[NSUserDefaults standardUserDefaults] valueForKey:@"courseDetails"] valueForKey:@"course_info"] valueForKey:@"BusinessProfile"] valueForKey:@"author_state"] valueForKey:@"state_name"]];
//    
//    locationStr = [locationStr stringByAppendingString:@", "];
//    
//    locationStr = [locationStr stringByAppendingString:[[[[[[NSUserDefaults standardUserDefaults] valueForKey:@"courseDetails"] valueForKey:@"course_info"] valueForKey:@"BusinessProfile"] valueForKey:@"author_country"] valueForKey:@"country_name"]];
...
//    location.text = locationStr;
//    
//    NSString *str = [[[NSUserDefaults standardUserDefaults] valueForKey:@"courseDetails"] valueForKey:@"offer_names"];
//    
...
//        storyboard = [UIStoryboard storyboardWithName:@"Main_Ipad" bundle:nil];
//        
//       [offers setFont:[UIFont systemFontOfSize:20]];
//        
//    } else {
//        
//        storyboard = [UIStoryboard storyboardWithName:@"Main_Iphone" bundle:nil];
//        
//         [offers setFont:[UIFont systemFontOfSize:17]];
//        
//    }
//    
//    offers.text = [[[NSUserDefaults standardUserDefaults] valueForKey:@"courseDetails"] valueForKey:@"offer_names"];
//    
//    str = [[[NSUserDefaults standardUserDefaults] valueForKey:@"courseDetails"] valueForKey:@"result_string"];
//    
//    height = [self heightCalculate:str];
//    
...
// //   [category sizeToFit];
//    
//    [category setLineBreakMode:NSLineBreakByClipping];
//    
...
//    
//    category.text = [[[NSUserDefaults standardUserDefaults] valueForKey:@"courseDetails"] valueForKey:@"result_string"];
//    
//    str = [[[NSUserDefaults standardUserDefaults] valueForKey:@"courseDetails"] valueForKey:@"subcategory_name"];
//    
//    height = [self heightCalculate:str];
//    
//    frame = sub_cat.frame;
...
////    [sub_cat sizeToFit];
//    
//    [sub_cat setLineBreakMode:NSLineBreakByClipping];
//    
//    [sub_cat  setNumberOfLines:0];
//    
//    [sub_cat  setBaselineAdjustment:UIBaselineAdjustmentAlignBaselines];
//    
//    [sub_cat setFont:[UIFont systemFontOfSize:17]];
//    
//    sub_cat.text = [[[NSUserDefaults standardUserDefaults] valueForKey:@"courseDetails"] valueForKey:@"subcategory_name"];
    
    CGRect Frame2 = awardView.frame;
    
    Frame2.origin.y = achievmentLbl.frame.origin.y + achievmentLbl.frame.size.height +5;
    
    awardView.frame = Frame2;
    
    frame1.origin.y = educator_description.frame.origin.y + educator_description.frame.size.height + 5;
    
    frame1.size.height = awardView.frame.origin.y + awardView.frame.size.height+5;
    
    sub_View.frame = frame1;
    
    frame1 = otherlisting_lbl.frame;
    
    frame1.origin.y = sub_View.frame.origin.y + sub_View.frame.size.height +30;
    
    otherlisting_lbl.frame = frame1;
    
    otherlisting_lbl.numberOfLines = 0;
    
    otherlisting_lbl.lineBreakMode = NSLineBreakByWordWrapping;
    
    [otherlisting_lbl sizeToFit];
    
    if (otherlisting_lbl.frame.size.width < self.view.frame.size.width- (2*(otherlisting_lbl.frame.origin.x))) {
        
        frame1 = otherlisting_lbl.frame;
        
        frame1.size.width = self.view.frame.size.width- (2*(otherlisting_lbl.frame.origin.x));
        otherlisting_lbl.frame = frame1;
    ...
    frame1.origin.y = otherlisting_lbl.frame.origin.y + otherlisting_lbl.frame.size.height +5;
...
-(void)fetchMyListing{
    ...
    memberId =[[[[[NSUserDefaults standardUserDefaults] valueForKey:@"courseDetails"]valueForKey:@"course_info"] valueForKey:@"CourseListing"] valueForKey:@"member_id"];
    ...
    [myListingConn startConnectionWithString:[NSString stringWithFormat:@"other_listing"] HttpMethodType:Post_Type HttpBodyType:paramURL Output:^(NSDictionary *receivedData){
        ...
        if ([myListingConn responseCode] == 1) {
            ...
            if ([[receivedData valueForKey:@"code"] integerValue] == 0) {
                ...
                scrollView.contentSize = CGSizeMake(self.view.frame.size.width, self.otherlisting_lbl.frame.origin.y +50);
                
                otherlisting_lbl.hidden = YES;
                
                NSLog(@"%f",self.otherlisting_lbl.frame.origin.y + otherlisting_lbl.frame.size.height +50);
...
- (IBAction)tap_otherListingBtn:(id)sender {
    ...
    [self performSegueWithIdentifier:@"otherListingSegue" sender:self];
}
@end
