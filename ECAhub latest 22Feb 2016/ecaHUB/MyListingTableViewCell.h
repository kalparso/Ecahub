...
@interface MyListingTableViewCell : UITableViewCell
...
@property (weak, nonatomic) IBOutlet UILabel *typeCity_static_lbl;
@property (weak, nonatomic) IBOutlet UILabel *catname_stlbl;
