...
@interface EventEducatorViewController : UIViewController <UITableViewDataSource,UITableViewDelegate>
...
@property (weak, nonatomic) IBOutlet UILabel *establisedLb;
@property (weak, nonatomic) IBOutlet UILabel *offersLbl;
@property (weak, nonatomic) IBOutlet UILabel *locationLbl;
@property (weak, nonatomic) IBOutlet UILabel *achivmentsLbl;
