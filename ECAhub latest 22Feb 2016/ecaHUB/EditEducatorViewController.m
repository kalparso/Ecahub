...
@interface EditEducatorViewController ()  {
...
@implementation EditEducatorViewController
...
-(void) prepareInterface {
    ...
    descriptionTxtView.text = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"CourseDetail"] valueForKey:@"course_info"] valueForKey:@"CourseListing"] valueForKey:@"description_educator"];
    ...
    educator_name.text = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"CourseDetail"] valueForKey:@"course_info"] valueForKey:@"CourseListing"] valueForKey:@"name_educator"];
    
    business_type.text = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"CourseDetail"] valueForKey:@"course_info"] valueForKey:@"BusinessType"] valueForKey:@"title"];
    
    address.text = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"CourseDetail"] valueForKey:@"course_info"] valueForKey:@"CourseListing"] valueForKey:@"author_venu_unit"];
    
    building_name.text = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"CourseDetail"] valueForKey:@"course_info"] valueForKey:@"CourseListing"] valueForKey:@"author_venu_building_name"];
    
    number_street.text = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"CourseDetail"] valueForKey:@"course_info"] valueForKey:@"CourseListing"] valueForKey:@"author_venu_street"];
    
    district.text = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"CourseDetail"] valueForKey:@"course_info"] valueForKey:@"CourseListing"] valueForKey:@"author_venu_district"];
    
    NSString *strValue;
    
    //= [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"CourseDetail"] valueForKey:@"course_info"] valueForKey:@"author_city"] valueForKey:@"city_name"];
//   
//    strValue = [@"  " stringByAppendingString:strValue];
//    
//    [cityBtn setTitle:strValue forState:UIControlStateNormal];
//    
//    strValue = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"CourseDetail"] valueForKey:@"course_info"] valueForKey:@"author_state"] valueForKey:@"state_name"];
//    
//    strValue = [@"  " stringByAppendingString:strValue];
//    
//    [stateBtn setTitle:strValue forState:UIControlStateNormal];
//    
//    strValue = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"CourseDetail"] valueForKey:@"course_info"] valueForKey:@"author_country"] valueForKey:@"country_name"] ;
//    
//    strValue = [@"  " stringByAppendingString:strValue];
//    
//    [countryBtn setTitle:strValue forState:UIControlStateNormal];
//    
    countryBtn.userInteractionEnabled = YES;
    stateBtn.userInteractionEnabled = YES;
    cityBtn.userInteractionEnabled = YES;
    
    established_year.text = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"CourseDetail"] valueForKey:@"course_info"] valueForKey:@"CourseListing"] valueForKey:@"year"];
    
    strValue = [[[NSUserDefaults standardUserDefaults] valueForKey:@"CourseDetail"] valueForKey:@"offer_names"];
...
-(void) setData {
    ...
    NSString *educator_nameStr = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"CourseDetail"] valueForKey:@"course_info"] valueForKey:@"CourseListing"] valueForKey:@"name_educator"];
    
    business_typeId = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"CourseDetail"] valueForKey:@"course_info"] valueForKey:@"BusinessType"] valueForKey:@"id"];
    
    NSString *addressStr = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"CourseDetail"] valueForKey:@"course_info"] valueForKey:@"CourseListing"] valueForKey:@"author_venu_unit"];
    
    NSString *building_nameStr = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"CourseDetail"] valueForKey:@"course_info"] valueForKey:@"CourseListing"] valueForKey:@"author_venu_building_name"];
    
    NSString *number_streetStr = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"CourseDetail"] valueForKey:@"course_info"] valueForKey:@"CourseListing"] valueForKey:@"author_venu_street"];
    
    NSString *districtStr = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"CourseDetail"] valueForKey:@"course_info"] valueForKey:@"CourseListing"] valueForKey:@"author_venu_district"];
    
//    country_id = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"CourseDetail"] valueForKey:@"course_info"] valueForKey:@"CourseListing"] valueForKey:@"author_country_id"];
//    
//    state_id = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"CourseDetail"] valueForKey:@"course_info"] valueForKey:@"CourseListing"] valueForKey:@"author_state_id"];
//    
//    city_id = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"CourseDetail"] valueForKey:@"course_info"] valueForKey:@"CourseListing"] valueForKey:@"author_city_id"];
    
    NSString *year = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"CourseDetail"] valueForKey:@"course_info"] valueForKey:@"CourseListing"] valueForKey:@"year"];
    
    offersId = [[[[[NSUserDefaults standardUserDefaults] valueForKey:@"CourseDetail"] valueForKey:@"course_info"] valueForKey:@"CourseListing"] valueForKey:@"offer"];
...
- (IBAction)tapOffersBtn:(id)sender {
    ...
    NSString *offerStr = [[[NSUserDefaults standardUserDefaults] valueForKey:@"CourseDetail"] valueForKey:@"offer_names"];
    
    [self showListData:[offersArray valueForKey:@"name"] allowMultipleSelection:YES selectedData:[offerStr componentsSeparatedByString:@","] title:@"Offers"];
}
