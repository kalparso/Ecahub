//
//  EditEventSessionViewController.h
//  ecaHUB
//
...
@interface EditEventSessionViewController : UIViewController <UITextFieldDelegate, listingDelegate, UIPickerViewDataSource, UIPickerViewDelegate>
...
@property (weak, nonatomic) IBOutlet UIButton *tap_infoBtn;
@property (weak, nonatomic) IBOutlet UIButton *main_Lg;
- (IBAction)tap_mainLg:(id)sender;
- (IBAction)tap_infoBtn:(id)sender;

@property (weak, nonatomic) IBOutlet UIButton *supporting_Lg;
